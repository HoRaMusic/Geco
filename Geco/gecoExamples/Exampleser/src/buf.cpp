...
struct buf : Module {
    ...
    PulseGenerator gat76_gatePulse;
    ...
    PulseGenerator gat66_gatePulse;
...
void buf::step() {
    ...
    if(mod_74_INPUT_signal != 0 && gat76_wasTrigged == false)
    {
        ...
        gat76_gatePulse.trigger(1e-3);
        gat76_pulse = gat76_gatePulse.process(1.0 / engineGetSampleRate());
  }
  ...
  if (mod_68_INPUT_signal > dou85_out) 
   ...
   x__Op84_result = 1;
    ...
    arr80_inputs[0] = cou75_count;
     ...
     arr80_inputs[2] = 0;
     arr80_inputs[3] = 0;
     for(int arr80_realsize; arr80_realsize < 3;arr80_realsize ++)
    {
...
lights[led_73_LIGHT].value = arr80_out;
    ...
    if(x__Op84_result + but_16_PARAM_output != 0 && gat66_wasTrigged == false)
    {
        ...
        gat66_gatePulse.trigger(1e-3);
        gat66_pulse = gat66_gatePulse.process(1.0 / engineGetSampleRate());
  }
